...
// src/client/reverse-video.ts
function reverseSampleAt(input) {
  if (input.seeking) {
  ...
  if (input.now - input.lastSampleAt < 1e3 / 30 && !complete) {
...
var TRANSPARENT_VIDEO_URL = "/plugins/dsh-liang-effort/liang-evolution.webm?v=76e807d1cc64";
var FALLBACK_VIDEO_URL = "/plugins/dsh-liang-effort/liang-evolution.mp4?v=4b40259a3ff4";
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (delta > 0) {
      ...
      const reverseSample = (now) => {
        ...
        if (sample.time !== void 0) video.currentTime = sample.time;
        if (!sample.complete) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `dle-portrait-shell${seeking ? " is-seeking" : ""}`, "data-level": visualIndex, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "video",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", { src: TRANSPARENT_VIDEO_URL, type: "video/webm; codecs=vp9" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", { src: FALLBACK_VIDEO_URL, type: "video/mp4" })
        ]
      }
    ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: rootRef, className: "dle-root", onKeyDown, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        disabled: locked,
        title: `${modelLabel}${committedEffort === void 0 ? "" : ` \xB7 ${committedEffort.label}(${committedEffort.id})`}`,
        onClick: () => {
          setOpen((value) => !value);
          if (!open) load();
        },
        children: [
          ...
          committedEffort !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dle-trigger-effort", children: [
            committedEffort.label,
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { id: panelId, className: "dle-panel", role: "dialog", "aria-label": "\u6A21\u578B\u4E0E\u6881\u6C0F\u63A8\u7406\u5F3A\u5EA6", children: [
      ...
      activeEffort !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dle-instrument", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dle-console", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dle-visually-hidden", "aria-live": "polite", children: [
            "\u5F53\u524D\u9009\u62E9\uFF1A",
            activeEffort.label
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dle-rail", style: { "--dle-progress": `${effortChoices.length <= 1 ? 100 : preview / (effortChoices.length - 1) * 100}%` }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dle-ticks", "aria-hidden": "true", children: effortChoices.map((choice, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { className: `dle-tick${index <= preview ? " is-active" : ""}${index === preview ? " is-current" : ""}` }, choice.id)) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dle-labels", style: { gridTemplateColumns: `repeat(${effortChoices.length}, minmax(0, 1fr))` }, "aria-hidden": "true", children: effortChoices.map((choice, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: index === preview ? "is-active" : "", title: `${choice.label}(${choice.id})`, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: choice.label }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", { children: [
                "(",
                choice.id,
                ")"
